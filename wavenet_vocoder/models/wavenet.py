...
from .modules import Conv1d1x1, ResidualConv1dGLU, ConvTranspose2d, Embedding, ReluActivation, \
    DiscretizedMixtureLogisticLoss, MaskedCrossEntropyLoss
        ...
        with tf.variable_scope('loss') as scope:
            if self.is_training:
                ...
                if is_mulaw_quantize(self._hparams.input_type):
                    ...
                    self.eval_loss = DiscretizedMixtureLogisticLoss(self.y_hat_eval, self.y_eval, hparams=self._hparams,
        ...
        def body(time, outputs_ta, current_input, loss_outputs_ta):
            ...
            if self.scalar_input:
                ...
                if quantize:
                    ...
                    sample = tf.multinomial(tf.reshape(x, [batch_size, -1]), 1)[
                        0]  # Pick a sample using x as probability

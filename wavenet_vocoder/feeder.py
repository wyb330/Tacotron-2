    ...
    def __init__(self, coordinator, metadata_filename, base_dir, hparams):
        ...
        if hparams.gin_channels > 0:
            raise NotImplementedError(
                'Global conditioning preprocessing has not been added yet, it will be out soon. Thanks for your patience!')
        ...
        with tf.device('/cpu:0'):
            ...
            if is_scalar_input(hparams.input_type):
                ...
                input_placeholder = tf.placeholder(tf.float32, shape=(None, hparams.quantize_channels, None),
                                                   name='audio_inputs')
